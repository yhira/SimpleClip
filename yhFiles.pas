...
procedure FindAllFilesWithExt(dir,ext:string;SL:TStringList);
//Dir内の全フォルダをリストアップ
procedure FindAllDirInDir(dir:string;SL:TStringList);
...
//          SL.Add(IncludeTrailingPathDelimiter(Dir) + Rec.Name);
//          FindAllDirInDir(IncludeTrailingPathDelimiter(Dir) + Rec.Name, SL);
//        end;
//      end;
//      Found := FindNext(Rec);
//    end;
